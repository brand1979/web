(function ( $, x5engine ) {
	...
	s.siteId = 'CAF3E7A9BAD95C7F66A7970EFA7A1D55';
	s.islocal = true;
	s.version = '17-1-2-0';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'K', path: 'captcha/imcpa_czn.gif'},
				"1": { letter: 'J', path: 'captcha/imcpa_mhx.gif'},
				"2": { letter: 'G', path: 'captcha/imcpa_eep.gif'},
				"3": { letter: 'K', path: 'captcha/imcpa_hw2.gif'},
				"4": { letter: 'Y', path: 'captcha/imcpa_kxk.gif'},
				"5": { letter: '8', path: 'captcha/imcpa_psg.gif'},
				"6": { letter: '2', path: 'captcha/imcpa_jvv.gif'},
				"7": { letter: '6', path: 'captcha/imcpa_dxm.gif'},
				"8": { letter: '6', path: 'captcha/imcpa_mut.gif'},
				"9": { letter: 'Z', path: 'captcha/imcpa_8ds.gif'}
			}
		});
	}, false, 'first');
